...
Sudos = {sudoid,1696907808,1696907808}
Sudo_Id = 1696907808
function Bot(msg)  
local idbot = false  
...
is_personal = true,
data = {
{{text = 'حـذف بــوت ✖️',type = 'text'},{text ='صـنع بـوت ➕',type = 'text'}},
{{text ='ايقاف بوت 〰️',type = 'text'},{text ='تـشـغيل بـوت ✔️',type = 'text'}},
{{text = 'تفعـيل الوضـع المـجاني',type = 'text'},{text ='تـعطـيل الوضـع المـجـاني ⏹',type = 'text'}},
{{text = 'مـعلـومـات الـسيـرفـر ⚠️',type = 'text'},{text ='المـصـنوعـات ♾', type = 'text'},{text ='الاحصائيات 🔘', type = 'text'}},
{{text = 'تصفية المصنوعات ♻️',type = 'text'}},
{{text = 'اذاعة 🔖',type = 'text'},{text = 'الاجباري 📢',type = 'text'}},
{{text = 'تـحـديـث الصـانـع 🔁',type = 'text'},{text = "تـحـديث المصـنوعـات🔄", type = 'text'}},
{{text = 'إلـغـاء 🚫',type = 'text'}},
}
}
...
is_personal = true,
data = {
{{text ='حذف البوت ✖️',type = 'text'},{text = 'صـنع بـوت ➕',type = 'text'}},
{{text = 'معـرفة المـزيد 📩',type = 'text'}},
}
}
...
is_personal = true,
data = {
{{text ='الـغـاء ✖️',type = 'text'},{text = 'تأكــيـد✅',type = 'text'}},
}
}
...
if text == 'اذاعة 🔖' then 
bot.sendText(msg.chat_id,msg.id,"*📩꒐ ارسل لي الاذاعة الان :*", 'md', false, false, false, false, bot.replyMarkup{type = 'keyboard',resize = true,is_personal = true,data = {{{text = 'إلـغـاء 🚫',type = 'text'}},}})
...
return bot.sendText(msg.chat_id,msg.id,"*📥꒐ قم الان بأرسال توجيه من القناة الان *","md", false, false, false, false, bot.replyMarkup{type = 'keyboard',resize = true,is_personal = true,data = {{{text = 'إلـغـاء 🚫',type = 'text'}},}})  
...
redis:setex(bot_id..":set:"..msg.chat_id..":addCh",600,true)  
return bot.sendText(msg.chat_id,msg.id,"*💢꒐ الاشتراك الاحباري مفعل على قناة :\n"..Info_Chats.invite_link.invite_link.."\n📭꒐ يمكنك تغييرها من خلال ارسال توجيه من قناة اخرى .\n🔖꒐ يمكنك الغاء العمليه من خلال الضغط اسفل .*","md", false, false, false, false, bot.replyMarkup{type = 'keyboard',resize = true,is_personal = true,data = {{{text = 'إلـغـاء 🚫',type = 'text'}},}})  
else
redis:setex(bot_id..":set:"..msg.chat_id..":addCh",600,true)  
return bot.sendText(msg.chat_id,msg.id,"*🔖꒐ ارسل لي توجية من القناة الأن :*","md", false, false, false, false, bot.replyMarkup{type = 'keyboard',resize = true,is_personal = true,data = {{{text = 'إلـغـاء 🚫',type = 'text'}},}})  
end
else
redis:setex(bot_id..":set:"..msg.chat_id..":addCh",600,true)  
return bot.sendText(msg.chat_id,msg.id,"*🔖꒐ ارسل لي توجية من القناة الأن :*","md", false, false, false, false, bot.replyMarkup{type = 'keyboard',resize = true,is_personal = true,data = {{{text = 'إلـغـاء 🚫',type = 'text'}},}})  
...
if text == 'تفعـيل الوضـع المـجاني' then
...
if text == 'تـعطـيل الوضـع المـجـاني ⏹' then
if redis:get(bot_id..":freebot") then
redis:del(bot_id..":freebot")
return bot.sendText(msg.chat_id,msg.id,'*✖️꒐ تم تـعطـيل الوضـع المـجـاني .*', 'md', false, false, false, false, reply_markup)
else
...
if text == "تـحـديث المصـنوعـات🔄" then
i = 0
...
if text == 'تـحـديـث الصـانـع 🔁' then    
...
if text == 'مـعلـومـات الـسيـرفـر ⚠️' then
...
• تاريخ الانشاء :* ( `2022/6/15` )
*⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯
- قناة شروحات السورس : @lZZIlI .
- بوت تواصل دعم السورس : @I_J_4bot .*

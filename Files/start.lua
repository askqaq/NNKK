...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " ليدر"
SudosS = {1696907808}
Sudos = {sudoid,1696907808}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = "أوامــر الحـمـاية" ,data="Amr_"..data.sender_user_id.."_1"},{text = "إعدادات المجموعة",data="Amr_"..data.sender_user_id.."_2"}},
{{text = "فـتـح/قفـل",data="Amr_"..data.sender_user_id.."_3"},{text ="اخرى",data="Amr_"..data.sender_user_id.."_4"}},
{{text = '- الاوامر الرئيسية .',data="Amr_"..data.sender_user_id.."_5"}},
}
}
if infomsg[2] == '1' then
reply_markup = reply_markup
t = "* ✠ ┇ اوامر الحماية اتبع مايلي\n *ٴ𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝗟𝗘𝗔𝗗𝗘𝗥ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻*\n ✠ ┇ قفل ، فتح ← الامر\n ✠ ┇ تستطيع قفل حماية كما يلي\n ✠ ┇ { بالتقييد ، بالطرد ، بالكتم ، بالتقييد }\n *ٴ𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝗟𝗘𝗔𝗗𝗘𝗥ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻*\n ✠ ┇ تاك\n ✠ ┇ القناة\n ✠ ┇ الصور\n ✠ ┇ الرابط\n ✠ ┇ السب\n ✠ ┇ الموقع\n ✠ ┇ التكرار\n ✠ ┇ الفيديو\n ✠ ┇ الدخول\n ✠ ┇ الاضافة\n ✠ ┇ الاغاني\n ✠ ┇ الصوت\n ✠ ┇ الملفات\n ✠ ┇ المنشورات\n ✠ ┇ الدردشة\n ✠ ┇ الجهات\n ✠ ┇ السيلفي\n ✠ ┇ التثبيت\n ✠ ┇ الشارحة\n ✠ ┇ الرسائل\n ✠ ┇ البوتات\n ✠ ┇ التوجيه\n ✠ ┇ التعديل\n ✠ ┇ الانلاين\n ✠ ┇ المعرفات\n ✠ ┇ الكيبورد\n ✠ ┇ الفارسية\n ✠ ┇ الانجليزية\n ✠ ┇ الاستفتاء\n ✠ ┇ الملصقات\n ✠ ┇ الاشعارات\n ✠ ┇ الماركداون\n ✠ ┇ المتحركات*"
...
{{text = ' ✠ ┇ تغيير اسم البوت',data="namebot"},{text =(redis:get(bot_id..":namebot") or "ليدر"),data="delnamebot"}},
...
reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = "أوامــر الحـمـاية" ,data="Amr_"..msg.sender.user_id.."_1"},{text = "إعدادات المجموعة",data="Amr_"..msg.sender.user_id.."_2"}},
{{text = "فـتـح/قفـل",data="Amr_"..msg.sender.user_id.."_3"},{text ="اخرى",data="Amr_"..msg.sender.user_id.."_4"}},
{{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𓅛𝗟𝗘𝗔𝗗𝗘𝗥.',url="https://t.me/LEDARQ"}},
}
}
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://https://t.me/LEDARQ&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعة" then
bot.sendText(msg.chat_id,msg.id,"*  ✠ ┇الساعة الان : ( "..os.date("%I:%M%p").." )*","md",true)  
end
if text == "شسمك" or text == "سنو اسمك" then
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "ليدر"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "ليدر"),"اني لقميل "..(redis:get(bot_id..":namebot") or "ليدر"),(redis:get(bot_id..":namebot") or "ليدر").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "ليدر") then
...
local UserId_Info = bot.searchPublicChat("L_U_2")
if UserId_Info.id then
